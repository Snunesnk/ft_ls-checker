...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/04 12:13:54 by snunes            #+#    #+#              #
#    Updated: 2019/09/05 13:32:00 by snunes           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
#!/bin/bash
...
./ft_ls -1R A a rootfile Rootfile > .result/r1 2>&1;
...
./ft_ls -1R 2>&1 | grep -v denied | wc -l | tr -d ' ' | tr -d '\n' > .result/r1 2>&1;
