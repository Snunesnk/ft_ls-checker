...
#    Updated: 2019/09/02 15:56:06 by snunes           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
#!/bin/bash
...
then
	...
	echo $red"Test "$nb_test": [ft_ls -1t] simple"$pos$cross$clear;
else
	((success+=1));
	echo $green"Test "$nb_test": [ft_ls -1t] simple"$pos$pos$tick$clear;
fi
rm -rf tests;
...
then
	...
	echo $red"Test "$nb_test": [ft_ls -1t] easy"$pos$cross$clear;
else
	((success+=1));
	echo $green"Test "$nb_test": [ft_ls -1t] easy"$pos$tick$clear;
fi
rm -rf tests;
...
then
	...
	echo $red"Test "$nb_test": [ft_ls -1t] harder"$pos$cross$clear;
else
	((success+=1));
	echo $green"Test "$nb_test": [ft_ls -1t] harder"$pos$tick$clear;
fi
rm -rf tests;
