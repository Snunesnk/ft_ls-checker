...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/04 12:15:12 by snunes            #+#    #+#              #
#    Updated: 2019/09/05 13:34:24 by snunes           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
#!/bin/bash
...
./ft_ls -1rt tests 2>&1 > .result/r1 2>&1;
